...
Scholar} {[}\^{}gscholar{]} \textbar{}
\href{https://orcid.org/0000-0002-0520-0621}{ORCID} {[}\^{}orcid{]}
\textbar{}
\href{https://www.webofscience.com/wos/author/record/U-4375-2019}{WoS}
{[}\^{}wos{]} \textbar{}
\href{https://www.linkedin.com/in/prof-alcunha/}{LinkedIn}
{[}\^{}linkedin{]} \textbar{}
\href{https://linktr.ee/prof_alcunha}{LinkTree} {[}\^{}ltree{]}
...
\section{\texorpdfstring{EXECUTIVE SUMMARY
\hrulefill}{EXECUTIVE SUMMARY }}\label{executive-summary}

\begin{quote}
André Luiz Barbosa Nunes da Cunha, Ph.D.~is an Assistant Professor of
Civil Engineering at the University of São Paulo (USP), Brazil. He
specializes in Transport Modelling, Artificial Intelligence, Urban
Mobility, and Traffic Simulation. His career blends academic rigor with
practical industry consultancy, specifically in highway safety and
infrastructure design.
\end{quote}

\subsection{Key Highlights}\label{key-highlights}

\begin{description}
\tightlist
\item[Academic Leadership]
Tenured-track professor at USP with international visiting positions in
Australia (UniMelb), Croatia (UNIZG), Portugal (UMINHO), and Germany
(TUM). \emph{All list of positions on Sec.~\ref{sec-academic}}
\item[Research Funding]
Secured over BRL 18.6 million (approx. USD 3.38M) in research grants for
projects spanning intelligent transport systems and sustainable mobility
solutions. \emph{All list of research funding at
Sec.~\ref{sec-academic}}
\item[Industry Impact]
Serves as a technical consultant for major highway concessionaires in
Brazil (CCR, ARTERIS), focusing on the design and validation of truck
escape ramps.
\item[Supervision]
Has supervised over 60 students, including 6 PhD and 15 MSc candidates,
alongside numerous undergraduate projects.
\item[Technical Expertise]
Proficient in AI tools (OpenCV, CrewAI), programming (Python, R, C++),
and traffic simulation software (VISSIM, AIMSUN, TSIS-CORSIM).
\end{description}

\subsection{Selected Key Publications}\label{selected-key-publications}

\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\item
  E-Bikes \& Network Impacts (2026): ``How Do E-Bikes Measure Up?
  Analyzing Speed Differences and Network Impacts of São Paulo's
  Bikesharing System'' --- Transportation.
\item
  Accessibility \& Equity (2025): ``E-bikes' impact on job accessibility
  and equity in São Paulo and Rio'' --- Transportation Research Part D:
  Transport and Environment.
\item
  AI \& Crash Prediction (2023): ``Integrating a non-gridded space
  representation into a graph neural networks model for citywide
  short-term crash risk prediction'' --- Urban Informatics.
\item
  Network Vulnerability (2021): ``Measuring urban road network
...
\subsection{Academic Appointments}\label{sec-academic}
...
\tightlist
\item
  \textbf{PhD Students}: 6 (3 completed, 3 ongoing)
\item
  \textbf{MSc Students}: 15 (12 completed, 3 ongoing)
\item
  \textbf{Scientific Initiation}: 18 (16 completed, 2 ongoing)
\item
  \textbf{Undergraduate Projects}: 25 completed
\end{itemize}

\section{\texorpdfstring{RESEARCH INCOME
\hrulefill {#sec-income}}{RESEARCH INCOME }}\label{research-income}
...
\tightlist
\item
  \emph{Students advised by prof. A.L. Cunha are underlined}
\end{itemize}
...
\item
  ...
  \href{https://doi.org/10.31224/5719}{10.31224/5719}\textgreater{}
\item
  \ul{LOURO, T.V.}; GRIGILON, A.B.; \textbf{CUNHA, A.L.}; GEURS, K.T.
  (2025) ``E-bikes' impact on job accessibility and equity in São Paulo
  and Rio''. Transportation Research Part D: Transport and Environment.
  \textless DOI:
...
\item
  ...
  ELMAR Symposium.
\item
  \ul{MORELLI, A.B.}; \textbf{CUNHA, A.L.} (2019) Identifying
  vulnerabilities in transport networks: a graph-theoretical approach.
  In: XXXIII ANPET -- Research and Teaching in Transport Congress, 2019,
  Balneário Camboriú. Proceedings of the XXXIII ANPET.
\item
  \ul{KURAMOTO, B.}; \textbf{CUNHA, A.L.} (2019) Usability and
...
\item
  ...
  algorithm. In: XXXIII ANPET, 2019, Balneário Camboriú. Proceedings of
  XXXIII ANPET.
\item
  \ul{MORELLI, A.B.}; \textbf{CUNHA, A.L.} (2019) A strategy for
...
\item
  \ul{KURAMOTO, B.}; \textbf{CUNHA, A.L.} (2018) Methodological proposal
...
\item
  \ul{MORELLI, A.B.}; \textbf{CUNHA, A.L.} (2018) Methods for evaluating
  traffic conditions using Google Traffic and Twitter data. In: XXXII
  ANPET, 2018, Gramado, RS. Proceedings of XXXII ANPET.
\item
  \ul{THEBIT, M.M.}; \textbf{CUNHA, A.L.} (2017) Comparison of traffic
  data available on the web and obtained by fixed sensors. In: XXXI
  ANPET, 2017, Recife. Proceedings of XXXI ANPET.
\item
  \ul{RIBEIRO, E.R.}; \textbf{CUNHA, A.L.} (2017) Exploratory analysis
  of a method for anomaly detection in traffic data using Wavelet. In:
  XXXI ANPET -- Research and Teaching in Transport Congress, 2017,
  Recife. Proceedings of the XXXI ANPET.
\item
  \ul{PANICE, N.R.}; \textbf{CUNHA, A.L.} (2017) Evaluation of a method
  for automatic truck axle detection in images. In: XXXI ANPET --
  Research and Teaching in Transport Congress, 2017, Recife. Proceedings
  of the XXXI ANPET.
\item
  \ul{OLIVEIRA, G.J.M.}; \textbf{CUNHA, A.L.} (2017) HCM calibration
  method for dual carriageways and expressways using Bayesian inference.
  In: XXXI ANPET -- Research and Teaching in Transport Congress, 2017,
  Recife. Proceedings of the XXXI ANPET.
\item
...
\item
  \ul{THEBIT, M.M.}; \textbf{CUNHA, A.L.}; PITOMBO, C.S. (2016)
  ...
  on Urban, Regional, Integrated and Sustainable Planning, 2016, Maceió.
  Proceedings of the 7th PLURIS.
\item
  \ul{RIBEIRO, E.R.}; \textbf{CUNHA, A.L.} (2016) Exploratory analysis
  of a method for defining a typical day using Wavelet transform and
